...
// #define TOPICO_PUBLISH   "MQTTINCBTempUmidSin"    /*tópico MQTT de envio de informações para Broker
...
// #define ID_MQTT  "INCBTempUmidSin"     /* id mqtt (para identificação de sessão)
...
void envia_informacoes_lora(float temp_lida, float umid_lida)
{
    ...
    Serial.print(dados_lora.temperatura);
    LoRa.endPacket();
}
